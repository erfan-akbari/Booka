...
function AboutUs() {
  return (
    <section class="flex items-center py-20 shadow-inner">
      <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-6 md:px-6">
        <div class="flex flex-wrap items-center">
          ...
          <div class="w-full px-4 mb-10 xl:w-1/2 lg:mb-8">
            <span class="text-sm font-semibold text-blue-500 dark:text-blue-400">چند کلمه درباره ما</span>
            ...
            <h2 class="mt-2 mb-4 text-2xl font-bold text-gray-700 dark:text-gray-300">فعالیت‌های آینده ما</h2>
            <ul class="mb-10">
